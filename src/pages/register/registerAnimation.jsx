...
export const initRegisterAnimations = (refs) => {
    ...
    .fromTo(formRef.current.querySelectorAll('.ant-form-item'), {
        opacity: 0,
        x: -100,
        rotation: -10,
        scale: 0.8
    ...
    .fromTo(formRef.current.querySelector('.submit__btn'), {
        opacity: 0,
        scale: 0,
        rotation: 180
    }, {
    ...
    .fromTo(buttonsRef.current.querySelectorAll('button'), {
        opacity: 0,
        y: 50,
        scale: 0,
        rotation: 45
